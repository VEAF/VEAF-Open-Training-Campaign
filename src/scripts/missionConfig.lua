...
--
-- This configuration is tailored for the Caucasus OpenTraining Campaign mission
-- see https://github.com/VEAF/VEAF-Open-Training-Campaign
-------------------------------------------------------------------------------------------------------------------------------------------------------------
veaf.config.MISSION_NAME = "OpenTraining_Campaign_Caucasus"
