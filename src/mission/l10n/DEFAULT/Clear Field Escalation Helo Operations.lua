	...
	if #USACEHAWKTable > 0 then
		for i = 1, #USACEHAWKTable do
			...
			--if ( GROUP:FindByName(USACEHAWKTable[i]):GetSize() > 7 ) then
				...
				ClearFieldMkIIConstructions[TableConstructor] = {}
				ClearFieldMkIIConstructions[TableConstructor].Type = "Hawk"
				ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
				ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACENASAMSTable > 0 then
		for i = 1, #USACENASAMSTable do
			...
			--if ( GROUP:FindByName(USACEHAWKTable[i]):GetSize() > 5 ) then
				...
				ClearFieldMkIIConstructions[TableConstructor] = {}
				ClearFieldMkIIConstructions[TableConstructor].Type = "NASAMS"
				ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
				ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
...
function EventHandlerHeloBirth:onEvent(Event)
	...
	if ( Event.id == world.event.S_EVENT_BIRTH and Event.initiator:getDesc().category == 1 and Event.initiator:getPlayerName() ~= nil ) then				
		...
		if ( EventGroupType == "UH-1H" or EventGroupType == "Mi-8MT" or EventGroupType == "SA342L" or EventGroupType == "SA342M" or EventGroupType == "SA342Minigun" or EventGroupType == "SA342Mistral" or EventGroupType == "Ka-50" or EventGroupType == "Mi-24P" ) then			 
